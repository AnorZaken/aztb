package nu.mine.obsidian.aztb.bukkit.recipes.v1_0;
...
public class RecipeHelper
{
	...
	private static boolean b_compareFurnaceStackSize = false; //Added this toggle in case bukkit starts supporting this
	...
	public static void compareFurnaceStackSizes(final boolean compareStackSize) {
	 ...
	 */
	public static boolean compareFurnaceStackSizes() {
	 ...
	 */
	public static boolean setMetaChecker(final Class<? extends Object> metaCheckerClass, final Object metaCheckerInstance)
	{
		final Class<? extends Object> clazz;
		clazz = metaCheckerInstance == null ? metaCheckerClass : metaCheckerInstance.getClass();
		return MetaCheckerHelper.TrySetMetaChecker(null, clazz, metaCheckerInstance);
	}
	 ...
	 */
	public static void setMetaChecker(final IMetaChecker metaChecker) {
		MetaCheckerHelper.TrySetMetaChecker(metaChecker, null, null);
	}
	 ...
	 * @see #setMetaChecker(IMetaChecker)
	 */
	public static Class<? extends Object> getMetaCheckerClass() {
	 ...
	 * @see #getMetaChecker()
	 */
	public static Object getMetaCheckerInstance() {
	 ...
	 * @see IMetaChecker
	 */
	public static IMetaChecker getMetaChecker() {
	 ...
	 * @see #setMetaChecker(IMetaChecker)
	 */
	public static List<Recipe> serverHasSimilarIngredientRecipe(final Server server, final boolean removeIfFound, final Recipe recipe)
	{
		if (server == null)
	 ...
	 * @see #isWildcardRecipe(Recipe)
	 */
	public static List<Recipe> addRecipesToServer(final Server server, final boolean allowOverwriteExisting, final Recipe... recipes)
	{
		if (server == null)
			throw new IllegalArgumentException("server is null");
	 ...
	 */
	public static boolean ingredientsMatch(final Recipe recipe1, final Recipe recipe2)
	{
		if (recipe1 == recipe2)
			return true;
	 ...
	 */
	public static boolean ingredientsMatchS(final ShapedRecipe shaped1, final ShapedRecipe shaped2)
	{
	 ...
	 * @see #ingredientsMatch(Recipe, Recipe)
	 */
	public static boolean ingredientsMatchSL(final ShapelessRecipe shapeless1, final ShapelessRecipe shapeless2)
	{
	 ...
	 * @see #ingredientsMatch(Recipe, Recipe)
	 */
	public static boolean ingredientsMatchSLS(final ShapelessRecipe shapeless, final ShapedRecipe shaped)
	{
		if(shapeless == null)
			return shaped == null;
		else if (shaped == null)
	 ...
	 * @see #compareFurnaceStackSizes()
	 */
	public static boolean ingredientsMatchF(final FurnaceRecipe fRecipe1, final FurnaceRecipe fRecipe2)
	{
	 ...
	 * @see #ingredientsMatchS(ShapedRecipe, ShapedRecipe)
	 */
	protected static boolean ingredientsMatchS0(final ShapedRecipe shaped1, final ShapedRecipe shaped2)
	{
	 ...
	 * @see #ingredientsMatchSL(ShapelessRecipe, ShapelessRecipe)
	 */
	protected static boolean ingredientsMatchSL0(final ShapelessRecipe shapeless1, final ShapelessRecipe shapeless2)
	{
	 ...
	 */
	protected static boolean ingredientsMatchSLS0(final ShapelessRecipe shapeless, final ShapedRecipe shaped)
	{
	 ...
	 * @see #ingredientsMatchF(FurnaceRecipe, FurnaceRecipe)
	 */
	protected static boolean ingredientsMatchF0(final FurnaceRecipe fRecipe1, final FurnaceRecipe fRecipe2, final boolean compareStackSize)
	{
	 ...
	 * @see IMetaChecker
	 */
	public static boolean itemStacksMatch(final ItemStack is1, final ItemStack is2, final boolean checkStackSize)
	{
		if (is1 == is2)
			return true;
		...
		{   //neither is1 nor is2 is null
			...
			if (MetaCheckerHelper.isMetaCheckerAvailable()) //Check meta-data?
			{
				//Verbose code:
	//			if (is1.hasItemMeta()) {
	//				if(is2.hasItemMeta())
	...
	//				return true; //None of them had any meta
				...
				if (is1.hasItemMeta()) {
					if(is2.hasItemMeta())
						...
						return false; //#1 had valid meta, #2 had no meta
				} else if (is2.hasItemMeta() && MetaCheckerHelper.isMetaValid(is2.getItemMeta()))
					return false; //#2 had valid meta, #1 had no meta
			}
	 ...
	 * @see #isWildcardRecipe(Recipe)
	 */
	public static boolean isWildcardItemStack(final ItemStack itemStack)
	{
	 ...
	 * @see #isWildcardItemStack(ItemStack)
	 */
	public static boolean isWildcardRecipe(final Recipe recipe)
	{
		if (recipe == null)
			return false;
	 ...
	 * @see #isWildcardRecipe(Recipe)
	 */
	public static boolean isWildcardRecipeS(final ShapedRecipe shaped)
	{
		if (shaped == null)
			return false;
		else {
	 ...
	 * @see #isWildcardRecipe(Recipe)
	 */
	public static boolean isWildcardRecipeSL(final ShapelessRecipe shapeless)
	{
		if (shapeless == null)
			return false;
		else {
	 ...
	 * @see #isWildcardRecipe(Recipe)
	 */
	public static boolean isWildcardRecipeF(final FurnaceRecipe fRecipe)
	{
	 ...
	 * @author AnorZaken
	 */
	protected static final class MetaCheckerHelper implements IMetaChecker
	{
		private static MetaCheckerHelper instance; //instances of this class are immutable :)
		...
		public static Class<? extends Object> getMetaCheckerClass()
		{
			final MetaCheckerHelper instance = MetaCheckerHelper.instance; //Localize the reference (tsafety)
			return instance == null ? null : instance.metaCheckerClass;
		}
		
		public static Object getMetaCheckerRaw()
		{
			final MetaCheckerHelper instance = MetaCheckerHelper.instance; //Localize the reference (tsafety)
			return instance == null ? null : instance.metaCheckerRaw;
		}
		
		public static IMetaChecker getMetaChecker()
		{
			final MetaCheckerHelper instance = MetaCheckerHelper.instance; //Localize the reference (tsafety)
			return instance == null ? null : instance.metaChecker;
		}
		 ...
		 */
		public static boolean isMetaCheckerAvailable() {
		 ...
		 */
		public static boolean isMetaSimilar(ItemMeta meta1, ItemMeta meta2)
		{
			final IMetaChecker metaChecker = MetaCheckerHelper.getMetaChecker(); //Localize the reference (tsafety)
		 ...
		 * @return (<code>true</code> if no metaChecker available)
		 */
		public static boolean isMetaValid(ItemMeta meta)
		{
			final IMetaChecker metaChecker = MetaCheckerHelper.getMetaChecker(); //Localize the reference (tsafety)
		 ...
		 * @see RecipeHelper#setMetaChecker(IMetaChecker)
		 */
		public static boolean TrySetMetaChecker(final IMetaChecker metaChecker, final Class<? extends Object> metaCheckerClass, final Object metaCheckerRaw)
		{
			if (metaChecker != null)
			{
				instance = new MetaCheckerHelper(metaChecker);
				return true;
			}
			...
			else
			{
	            ...
	            instance = new MetaCheckerHelper(metaCheckerClass, metaCheckerRaw, aim, ivm);
	            return true;
	        }
		}
